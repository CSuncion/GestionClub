...
namespace GestionClubView.Venta
{
    public partial class frmNotaDeCredito : Form
    {
        ...
        public void ActualizarListaComprobanteDeBaseDatos()
        {
            ...
            this.eLisComp = GestionClubComprobanteController.ListarComprobantesNotaDeCredito(iOpEN).Where(x => x.caja == Universal.caja.ToString()).ToList();
        }
        ...
        {
            //preguntar si el registro seleccionado existe
            GestionClubComprobanteDto iComEN = this.EsProductoNotaCredito();
        ...
        public GestionClubComprobanteDto EsProductoNotaCredito()
        {
            GestionClubComprobanteDto iObjEN = new GestionClubComprobanteDto();
            this.AsignarComprobante(iObjEN);
