...
{
    public partial class frmEditarRegularizacionAnticipo : Form
    {
        ...
        public string eTitulo = "Regularización Anticipación";
        ...
        public void GenerarCorrelativo()
        {
            ...
            this.txtSerDoc.Text = "F" + gestionClubCorrelativoComprobanteDto.serCorrelativo;
        ...
        public void ListarProducto()
        {
            ...
            win.eCondicionLista = frmListarProducto.Condicion.ProductoAnticipo;
            TabCtrl.InsertarVentana(this, win);
            win.NuevaVentana();
        }
        ...
        {
            Cmb.Cargar(this.cboTipDoc,
                GestionClubGeneralController.ListarSistemaDetallePorTablaPorObs(GestionClubEnum.Sistema.DocFac.ToString(), "pedidos")
                .Where(x => x.codigo == "01")
                .OrderByDescending(x => x.idTabSistemaDetalle)
                .ToList(), GestionClubSistemaDetalleDto._codigo, GestionClubSistemaDetalleDto._descri);
        }
        ...
        public void MostrarComprobante(GestionClubComprobanteDto pObj)
        {
            ...
            this.cboTipoDocCmp.SelectedValue = "01";
        }
