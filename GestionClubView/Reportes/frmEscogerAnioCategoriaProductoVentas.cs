...
{
    public partial class frmEscogerAnioCategoriaProductoVentas : Form
    {
        public frmEscogerAnioCategoriaProductoVentas()
        {
            InitializeComponent();
        }
        ...
        {
            frmReportVentasCategoriasProductos win = new frmReportVentasCategoriasProductos();
            win.wFrm = this;
        ...
        public void Cerrar()
        {
            ...
            wMen.CerrarVentanaHijo(this, wMen.tsmVentasPorCategoriasProductos, null);
        }
