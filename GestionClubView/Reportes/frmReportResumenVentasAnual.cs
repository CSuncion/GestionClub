...
{
    public partial class frmReportResumenVentasAnual : Form
    {
        public frmEscogerAnioCategoriaVentas wFrm;
        ...
        public string nombreReporte = "GestionClubView.Reportes.rptListadoResumenVentasAnual.rdlc";
        public string formaReporte = "Normal";
        public frmReportResumenVentasAnual()
        {
            InitializeComponent();
        }
        ...
        public void GenerarInforme()
        {
            ...
            try
            {
                ...
                rds.Name = "dsResumenVentasAnual";
                rds.Value = GestionClubComprobanteController.ListarResumenVentasAnual(this.wFrm.txtAnio.Text, Cmb.ObtenerValor(this.wFrm.cboCategoria));
