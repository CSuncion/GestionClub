...
{
    public partial class frmIngresarAnioTopVentaProductos : Form
    {
        public frmIngresarAnioTopVentaProductos()
        {
            InitializeComponent();
        }
        ...
        public void SeleccionarFecha()
        {
            ...
            frmReportTopProductosVendidos win = new frmReportTopProductosVendidos();
            win.wFrm = this;
        ...
        public void Cerrar()
        {
            ...
            wMen.CerrarVentanaHijo(this, wMen.tsmTopProductos, null);
        }
