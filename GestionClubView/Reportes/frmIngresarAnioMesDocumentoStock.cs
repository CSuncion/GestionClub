...
{
    public partial class frmIngresarAnioMesDocumentoStock : Form
    {
        public frmIngresarAnioMesDocumentoStock()
        {
            InitializeComponent();
        }
        ...
        public void SeleccionarFecha()
        {
            ...
            frmReportRelacionMensualDocumentoStock win = new frmReportRelacionMensualDocumentoStock();
            win.wFrm = this;
        ...
        public void Cerrar()
        {
            ...
            wMen.CerrarVentanaHijo(this, wMen.tsmMovMensualStock, null);
        }
