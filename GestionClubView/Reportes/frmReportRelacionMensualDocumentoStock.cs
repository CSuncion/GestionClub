...
{
    public partial class frmReportRelacionMensualDocumentoStock : Form
    {
        public frmIngresarAnioMesDocumentoStock wFrm;
        ...
        public string nombreReporte = "GestionClubView.Reportes.rptRelacionMensualStock.rdlc";
        public string formaReporte = "Horizontal";
        public frmReportRelacionMensualDocumentoStock()
        {
            InitializeComponent();
        }
        ...
        public void GenerarInforme()
        {
            try
            {
                ...
                rds.Name = "dsRelacionMensualStock";
                rds.Value = GestionClubComprobanteAlmacenController.ListaResumenMensualStock(this.wFrm.txtAnio.Text, Cmb.ObtenerValor(this.wFrm.cboMes));
