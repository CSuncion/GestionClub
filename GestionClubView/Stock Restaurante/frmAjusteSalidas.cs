...
{
    public partial class frmAjusteSalidas : Form
    {
        ...
        public void ActualizarListaComprobanteAlmacenDeBaseDatos()
        {
            ...
            this.eLisComp = GestionClubComprobanteAlmacenController.ListarComprobantes(iOpEN).Where(x => x.tipFactura == "06").ToList();
        }
        ...
        public void Cerrar()
        {
            ...
            wMen.CerrarVentanaHijo(this, wMen.tsmAjustesSalidas, null);
        }
        ...
        public void AccionModificar()
        {
            ...
            //si existe
            frmEditarAjusteSalidas win = new frmEditarAjusteSalidas();
            win.wFrm = this;
